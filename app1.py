...
REPO_NAME = "Abdullahshade/repotwoforpen"  # Replace with your GitHub repository name
FILE_PATH = "chunk_2.csv"  # Path to metadata CSV in your GitHub repo
repo = g.get_repo(REPO_NAME)

# Define the paths
images_folder = "chunk2"  # Path to your images folder (update as needed)
